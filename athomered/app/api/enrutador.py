...
api.include_router(
    profesional_panel.router, prefix="/profesional", tags=["panel profesional"]
)
api.include_router(
    familiar_panel.router, prefix="/familiar", tags=["panel familiar"]
)
api.include_router(
    preferencias.router, prefix="/preferencias", tags=["preferencias"]
)
